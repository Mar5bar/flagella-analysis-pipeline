...
T.Properties.VariableUnits{'averageFlagAngleFromBase'} = 'radians';
...
T.Properties.VariableUnits{'meanCurvSinglePeriodSmoothed'} = 'radians / um';
T.Properties.VariableUnits{'medianCurvSinglePeriodSmoothed'} = 'radians / um';
...
T.Properties.VariableDescriptions{'averageFlagAngleFromBase'} = 'Average angle made by the flagellum tangent measured from the body axis. Averaged over arclength and time.';
...
T.Properties.VariableDescriptions{'maxCurvSinglePeriodSmoothed'} = 'Maximum signed curvature recorded in a single period from smoothed angular data.';
...
T.Properties.VariableDescriptions{'meanCurvSinglePeriodSmoothed'} = 'Mean signed curvature recorded in a single period from smoothed angular data. Averaged over time and arclength.';
T.Properties.VariableDescriptions{'medianCurvSinglePeriodSmoothed'} = 'Median signed curvature recorded in a single period from smoothed angular data. Averaged over time and arclength.';
T.Properties.VariableDescriptions{'minCurvSinglePeriodSmoothed'} = 'Minimum signed curvature recorded in a single period from smoothed angular data.';
